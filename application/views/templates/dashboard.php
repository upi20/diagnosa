...
<body class="desktop-detected pace-done smart-style-<?= $template_type ?> <?= $page_setting ?>">
	...
	<header id="header">
		<div id="logo-group">
			...
			<span id="logo" style="width: auto; margin-top: 0;">
				<h5><b style="color:white"><?= $app_name ?></b></h5>
			</span>
			...
			<ul id="mobile-profile-img" class="header-dropdown-list hidden-xs padding-5">
				<li class="">
					...
					<ul class="dropdown-menu pull-right">
						...
						<li class="divider"></li>
						<li>
							<a href="<?= base_url() ?>login/logout" class="padding-10 padding-top-5 padding-bottom-5" data-action="userLogout" data-logout-msg="Apakah anda yakin ingin logout ?"><i class="fa fa-sign-out fa-lg"></i> <strong>Logout</strong></a>
						</li>
					</ul>
				</li>
			</ul>
