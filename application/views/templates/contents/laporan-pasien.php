                        ...
                        <div class="widget-body">
                            ...
                            <div class="pull-right">
                                <?php if ($this->input->get('start_date') != '' && $this->input->get('end_date') != '') : ?>
                                    <a target="_blank" style="float: right;" href="<?= base_url('laporan/pasien/cetak?start_date=' . $this->input->get('start_date') . '&end_date=' . $this->input->get('end_date')) ?>" class="btn btn-danger">
                                        <i class="fa fa-file fa-fw"></i><b> CETAK PDF</b>
                                    </a>
                                <?php else : ?>
                                    <a target="_blank" style="float: right;" href="<?= base_url('laporan/pasien/cetak') ?>" class="btn btn-danger">
                                        <i class="fa fa-file fa-fw"></i><b> CETAK PDF</b>
                                    </a>
                                <?php endif; ?>
                            </div>
                            <table id="dt_basic" class="table table-striped table-bordered table-hover" width="100%">
                                <thead>
                                    <tr>
                                        ...
                                        <th data-class="expand"><i class="fa fa-fw fa-user text-muted hidden-md hidden-sm hidden-xs"></i> No.Telp Pasien</th>
                                        <th data-hide="phone"><i class="fa fa-fw fa-check text-muted hidden-md hidden-sm hidden-xs"></i> Status</th>
                                        <th data-hide="phone"><i class="fa fa-fw fa-check text-muted hidden-md hidden-sm hidden-xs"></i> Hasil Diagnosa</th>
                                        <th data-hide="phone"><i class="fa fa-fw fa-check text-muted hidden-md hidden-sm hidden-xs"></i> Tanggal Daftar</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <?php $no = 1;
