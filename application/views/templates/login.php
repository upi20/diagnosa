...
<html lang="en-us" id="extr-page">
	...
	<body class="animated fadeInDown">
		...
		<header id="header">
			...
			<div id="logo-group" style="display: none;">
				<span id="logo"> <img src="<?= base_url() ?>assets/img/SIPADI PESPA_original.png" alt="logo" style='margin-top: -35px; width: 100px;'> </span>
			</div>
